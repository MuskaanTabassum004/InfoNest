    ...
    <div className="min-h-screen" style={{ backgroundColor: '#EFEDFA' }}>
      ...
      >
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-7xl font-bold text-white mb-6" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
            Welcome to InfoNest
          </h1>
          <p className="text-2xl md:text-3xl text-white mb-4 font-light" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
            Where Documentation Meets Efficiency
          </p>
          <p className="text-xl text-white max-w-3xl mx-auto mb-12 leading-relaxed" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
            Centralized knowledge hub for your organization's documentation. 
            Discover, search, and access all your important documents in one secure, organized platform.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Powerful features designed to streamline your documentation workflow and enhance team collaboration
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Find any document instantly with our advanced full-text search across titles, content, and metadata.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Secure permissions system with User, InfoWriter, and Admin roles to control access and editing rights.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Stay current with live updates, version tracking, and instant notifications when content changes.
              </p>
            </div>
          </div>
        </div>
